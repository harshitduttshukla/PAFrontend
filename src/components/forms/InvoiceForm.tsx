...
const InvoiceForm: React.FC = () => {
  ...
  const handleReservationSelect = (reservation: Reservation) => {
    setSelectedReservationId(reservation.id); // 🔥 Save reservation ID
  ...
  // 🔥 FULL SAVE API FUNCTION (Final working)
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}api/createInvoice`, {
        method: "POST",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        ...
        {/* ************* YOUR FULL FORM UI BELOW (unchanged) ************* */}
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            {/* SAME UI for Services Name, Amount, Date, PAN, Round Off, Guest Width... */}
            {/* NO UI CHANGES — just including your code unchanged */}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  value={formData.date}
                  onChange={(e) => handleInputChange('date', e.target.value)}
                  className="w-full border border-gray-300 rounded px-3 py-2 pr-10 focus:outline-none"
                />
                <Calendar className="absolute right-3 top-2.5 text-gray-400" size={20} />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            {/* ... your remaining inputs (NO CHANGES MADE)... */}
